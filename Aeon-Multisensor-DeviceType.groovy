...
*/
		// Request temp and humidity
        zwave.configurationV1.configurationSet(parameterNumber: 101, size: 4, scaledConfigurationValue: 96).format(),
        // Set data reporting period to 2 mins for temp and humidity
        zwave.configurationV1.configurationSet(parameterNumber: 111, size: 4, scaledConfigurationValue: 120).format(),
        
        // Request illuminance and battery
        zwave.configurationV1.configurationSet(parameterNumber: 102, size: 4, scaledConfigurationValue: 129).format(),
        // Set reporting period to 3 mins for illuminance
        zwave.configurationV1.configurationSet(parameterNumber: 112, size: 4, scaledConfigurationValue: 180).format()
	])
}
